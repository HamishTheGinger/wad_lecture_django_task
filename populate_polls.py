import os
os.environ.setdefault('DJANGO_SETTINGS_MODULE','wad_lecture_django_task.settings')
...
def populate():
    ...
    {"choice_text": "Just hacking again", "votes": 2},] 

    questions = {"What's up?": {"choices":question1_choices, "pub_date":datetime(2024, 10, 17, 15, 30,tzinfo=utc)}, }
